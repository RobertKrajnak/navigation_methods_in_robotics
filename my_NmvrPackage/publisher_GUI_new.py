...
def odometry_setting():
    ...
    if last_theta == robot_angles[0]:
        left_wheel = [robot_lastpose_col, robot_lastpose_row - 0.5]
        right_wheel = [robot_lastpose_col, robot_lastpose_row + 0.5]
    elif last_theta == robot_angles[1]:
        left_wheel = [robot_lastpose_col + 0.35, robot_lastpose_row - 0.35]
        right_wheel = [robot_lastpose_col - 0.35, robot_lastpose_row + 0.35]
    elif last_theta == robot_angles[2]:
        left_wheel = [robot_lastpose_col + 0.5, robot_lastpose_row]
        right_wheel = [robot_lastpose_col - 0.5, robot_lastpose_row]
